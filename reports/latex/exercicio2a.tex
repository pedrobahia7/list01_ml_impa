...
os elementos fora da diagonal são todos zero.

Já assumir a homocedasticidade implica que a variância dos erros é constante, ou seja, \[ \text{Var}(\varepsilon_i) = \text{Var}(\varepsilon_j) = \sigma^2, para todo i,j\]
