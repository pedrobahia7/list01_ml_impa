...
\begin{itemize}
    ...
    \item \textbf{Lasso Regression}: Regularização L1 com seleção automática de features
\end{itemize}
...
\subsubsection{Implementação dos Algoritmos}
...
\subsubsection{Seleção do Parâmetro de Regularização}
...
\begin{figure}[h]
    ...
    \caption{Comparação dos erros no conjunto de teste para diferentes métodos}
