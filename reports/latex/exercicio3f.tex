...
A Figura \ref{fig:regression_fits_3f} compara visualmente os ajustes:
...
A Figura \ref{fig:regression_fits_outlier_3f} mostra o impacto do outlier:
...
\begin{figure}[H]
    ...
    \label{fig:regression_fits_outlier_3f}
\end{figure}
